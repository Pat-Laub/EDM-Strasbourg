...
md"""
Time horizon:
$(@bind T1 Slider(0.00:0.005:1.0; default=1.0))
DE parameter ρ:
$(@bind ρ Slider(1:50; default=10, show_value=true))
"""

# ╔═╡ 88f88dfc-aa0e-4478-bd58-7bc3bd82aab9
begin
	ts = trajectory(Systems.lorenz(ρ = ρ), 20, [0.0, 10.0, 0.0], Δt = 0.01);
	x = ts[:,1]
	y = ts[:,2]
	z = ts[:,3]
	
	ts2 = trajectory(Systems.lorenz(ρ = ρ), 20, [0.0, 11.0, 0.0], Δt = 0.01);
end;
...
md"##### One three-dimensional time series"

# ╔═╡ b2d4682f-2a30-4fa6-b6f2-ce38009c59e0
md"""
Time horizon:
$(@bind T2 Slider(0.00:0.005:1.0; default=0.25))
Rotation: 
$(@bind bc1 Slider(0:90; default=45))
$(@bind bc2 Slider(0:90; default=25))
"""
...
# ╔═╡ 5bf95bbe-195c-4190-bedc-e9eccd56a210
md"""
Time horizon:
$(@bind T3 Slider(0.00:0.0001:1.0; default=0.25))
Rotation: 
$(@bind chaosc1 Slider(0:90; default=45))
$(@bind chaosc2 Slider(0:90; default=25))
"""
...
# ╔═╡ 323983e6-8221-4a44-b208-85dcb121a0e6
md"Quantified by the _Lyapunov exponent_."

# ╔═╡ 37f3c72f-751d-4759-a38f-e10884fe870d
md"### Delayed embedding reconstruction"

# ╔═╡ cac1c010-446f-4335-b6ba-5b8be6ad3145
md"""
Time horizon:
$(@bind T4 Slider(0.001:0.001:1.0; default=0.05))
"""
...
md"##### Lagged embedding of $x$"

# ╔═╡ 3cd0e56b-bcb1-4332-91a8-7862156e3256
md"""
Time horizon:
$(@bind xEmbedT Slider(0.00:0.005:1.0; default=1.0))
Rotation: 
$(@bind xEmbedC1 Slider(0:90; default=45))
$(@bind xEmbedC2 Slider(0:90; default=25))
"""
...
md"##### Comparing the original $(x,y,z)$ system to the lagged embedding of $x$"

# ╔═╡ 861c83ed-0d77-4d5f-9ef0-9759c7678049
md"""
Time horizon:
$(@bind bxT Slider(0.00:0.005:1.0; default=1.0))
Rotation: 
$(@bind bxC1 Slider(0:90; default=45))
$(@bind bxC2 Slider(0:90; default=25))
"""

# ╔═╡ b54a247e-c068-4c4f-83db-2a85beb127bb
let	
	gap = 100
...
# ╔═╡ 34780678-cdf2-4f67-b06a-929aa032fc3b
md"""
Time horizon:
$(@bind yEmbedT Slider(0.00:0.005:1.0; default=1.0))
Rotation: 
$(@bind yEmbedC1 Slider(0:90; default=45))
$(@bind yEmbedC2 Slider(0:90; default=25))
"""
...
md"##### Comparing the $(x,y,z)$ system to the lagged embeddings of $x$ and $y$"

# ╔═╡ 8431100e-dca6-49bd-9c08-edb2271ddec1
md"""
Time:
$(@bind bxyT Slider(0.00:0.005:1.0; default=1.0))
Rotation: 
$(@bind bxyC1 Slider(0:90; default=45))
$(@bind bxyC2 Slider(0:90; default=25))
$(@bind bxyGap Slider(0:500; default=100))
"""

# ╔═╡ bd40c43d-384d-41b4-8aed-b33b0c3d56c3
let	
	gap = bxyGap
...
md"##### Comparing the lagged embedding of $x$ to that of $y$"

# ╔═╡ d79e6bcb-93a5-4975-b9f7-112cf1e65af8
md"""
Time:
$(@bind xyEmbedT Slider(0.00:0.005:1.0; default=1.0))
Rotation: 
$(@bind xyEmbedC1 Slider(0:90; default=45))
$(@bind xyEmbedC2 Slider(0:90; default=25))
$(@bind xyGap Slider(0:500; default=100))
"""
...
julia_version = "1.8.3"
manifest_format = "2.0"
project_hash = "c9ff623b2afc81ea8f4a787c7ff23f833214bd61"
...
git-tree-sha1 = "10f5484c480dbc476c2bf4e4bd5a025a1dbed629"
...
[[deps.DiffEqBase]]
deps = ["ArrayInterfaceCore", "ChainRulesCore", "DataStructures", "Distributions", "DocStringExtensions", "FastBroadcast", "ForwardDiff", "FunctionWrappers", "LinearAlgebra", "Logging", "MuladdMacro", "NonlinearSolve", "Parameters", "Printf", "RecursiveArrayTools", "Reexport", "Requires", "SciMLBase", "Setfield", "SparseArrays", "Static", "StaticArrays", "Statistics", "ZygoteRules"]
git-tree-sha1 = "a3917302153e04abf668725af7d8de66b9e1c944"
...
git-tree-sha1 = "91368447f98b0d0cbc31c089e27a07f281db741d"
...
git-tree-sha1 = "0aab57f178659e4fc182c367392f7156905cd919"
...
git-tree-sha1 = "ea32fbe1b9a274d9cf02199098f62b08e49397cf"
