...
1. Brief game about ABC
2. 🪄Empirical Dynamic Modelling🪄
3. Better performance in statistical computing

# ABC {data-visibility="uncounted" background-image="unsw-yellow-shape.png"}

![Our IME paper](abc-abstract.png)
...
# x = chicago["Temperature"].to_numpy(dtype=float)
# x /= x.mean()
```
...
```{python}
df = pd.read_csv("lorenz-rho-50.csv")
...
```{python}
M, y = fastEDM.create_manifold_and_targets(t, x, E=E, tau=20, p=10)
# M = M[:, ::-1]  # reverse the order of the columns
...
# smap_pred = np.dot(C_t.T, [1] + point)
# point
``` 
...
```{python}
#| echo: false
# Make a 1xE grid of scatterplots showing the relationship between the columns in the manifold
...
for i, ax in enumerate(axes):
  # Control size of ax.scatter points using the argument named "s"

  ax.scatter(manifold.iloc[:, i], targets, s=0.5)
  ax.set_xlabel(f"Lag {i+1}")

  # Fit a straight line to manifold[:, i] and targets
  slope, intercept, r_value, p_value, std_err = stats.linregress(manifold.iloc[:, i], targets.to_numpy().flatten())
  xs = np.linspace(ax.get_xlim()[0], ax.get_xlim()[1], 100)
  preds = slope * xs + intercept
  ax.plot(xs, preds, color=colors[1])

  # Save the xlim/ylim for each subplot
  xlim = ax.get_xlim()
  ylim = ax.get_ylim()
...
for i, ax in enumerate(axes):
  ...
  for j, x in enumerate(xs):
    avg_point = np.zeros(E+1)
    avg_point[0] = 1.0
    avg_point[1:] = manifold.mean(axis=0).values
    avg_point[i+1] = x
    preds[j] = np.dot(C_t.T, avg_point)
...
<img style="" data-natural-width="717" data-natural-height="478" data-lazy-loaded="" data-src="https://s3.amazonaws.com/media-p.slid.es/uploads/782452/images/8159712/pasted-from-clipboard.png">

<img data-natural-width="239" data-natural-height="206" style="" data-lazy-loaded="" data-src="https://s3.amazonaws.com/media-p.slid.es/uploads/782452/images/8159713/pasted-from-clipboard.png">

##

<img style="" data-natural-width="1806" data-natural-height="1350" data-lazy-loaded="" data-src="https://s3.amazonaws.com/media-p.slid.es/uploads/782452/images/8159740/pasted-from-clipboard.png">
...
<a href="http://cs.brown.edu/courses/csci1310/2020/assign/labs/lab4.html" target="_blank">http://cs.brown.edu/courses/csci1310/2020/assign/labs/lab4.html</a>
 
::: columns
::: column

<img style="" data-natural-width="975" data-natural-height="552" data-lazy-loaded="" data-src="https://s3.amazonaws.com/media-p.slid.es/uploads/782452/images/8164394/caches.png"><
...
# Profiling the code {data-background-image="unsw-yellow-shape.png" data-visibility="uncounted"}

(use _snakeviz_, _lineprofiler_)
...
<img style="" data-natural-width="1262" data-natural-height="1058" data-lazy-loaded="" data-src="https://s3.amazonaws.com/media-p.slid.es/uploads/782452/images/8168942/pasted-from-clipboard.png">

:::
::: column

<img style="" data-natural-width="2247" data-natural-height="1193" data-lazy-loaded="" data-src="https://s3.amazonaws.com/media-p.slid.es/uploads/782452/images/8168943/pasted-from-clipboard.png">
...
<img data-natural-width="2359" data-natural-height="1350" style="" data-lazy-loaded="" data-src="https://s3.amazonaws.com/media-p.slid.es/uploads/782452/images/8163861/lin-clark-arrival.png">
...
<img data-natural-width="2272" data-natural-height="1350" style="left: -84px; top: 0px; width: 650px; height: 386px;" data-crop-x="0.130014" data-crop-y="0" data-crop-width="0.672199" data-crop-height="1" data-lazy-loaded="" data-src="https://s3.amazonaws.com/media-p.slid.es/uploads/782452/images/8159824/lin-clark-compiler.png">

<img style="left: -93px; top: 0px; width: 663px; height: 386px;" data-natural-width="2318" data-natural-height="1350" data-crop-x="0.139918" data-crop-y="0" data-crop-width="0.744856" data-crop-height="1" data-lazy-loaded="" data-src="https://s3.amazonaws.com/media-p.slid.es/uploads/782452/images/8159825/lin-clark-interpreter.png">
...
## What does a machine understand? {.smaller}
...
<img style="left: -180px; top: 0px; width: 802px; height: 518px;" data-natural-width="2090" data-natural-height="1350" data-crop-x="0.224439" data-crop-y="0" data-crop-width="0.775561" data-crop-height="1" data-lazy-loaded="" data-src="https://s3.amazonaws.com/media-p.slid.es/uploads/782452/images/8159836/lin-clark-type-checking.png">
...
## Multiple threads or multiple processes? {.smaller}
