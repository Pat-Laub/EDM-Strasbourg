...
# EDM Algorithms {data-background-image="unsw-yellow-shape.png" data-visibility="uncounted"}
...
mani = fastEDM.create_manifold(list(t), list(x), E=E, tau=tau, p=p)
...
## Create a mini-dataset based on neighbours
